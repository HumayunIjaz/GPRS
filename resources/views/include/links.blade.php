...
<link rel='dns-prefetch' href='http://maps.googleapis.com/' />
    ...
    <link rel="icon" href="{{asset('public/upload/cropped-fav-gradient-150x150.png')}}" sizes="32x32" />
   
    <link rel="icon" href="{{asset('public/upload/cropped-fav-gradient-300x300.png')}}" sizes="192x192" />
    
    <link rel="apple-touch-icon-precomposed" href="{{asset('public/upload/cropped-fav-gradient-300x300.png')}}" />

    <link rel='stylesheet'   href="{{asset('public/css/modules.mina288.css')}}" type='text/css' media='all' />

 <link rel="stylesheet" href="{{asset('public/js/bootstrap.min.js')}}">
  <script type='text/javascript' src="{{asset('public/js/jqueryb8ff.js')}}"></script>
