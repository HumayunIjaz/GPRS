                        ...
                        <!-- PAGE CONTENT BEGINS -->
                            <form  action="{{ route('progress.update', $progress[0]->id ) }}" method="POST" class="form-horizontal" role="form"  autocomplete="off" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" value="{{$progress[0]->sms1}}" name="semes1" placeholder="Semester 1"  >
                                            <option value=""></option>
                                            <option value="Submite">Submite</option>
                                            <option value="Note Submite">Note Submite</option>
                                        </select>
                                    </div>
                                    <label  class="col-sm-2 control-label">Semester 2:</label>
                                    <div class="col-sm-2">
                                        <select class="form-control" value="{{$progress[0]->sms2}}" name="semes2" placeholder="Semester 1"  >
                                            <option value=""></option>
                                            <option value="Submite">Submite</option>
                                            <option value="Note Submite">Note Submite</option>
                                        </select>
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" value="{{$progress[0]->sms3}}" name="semes3" placeholder="Semester 1"  >
                                            <option value=""></option>
                                            <option value="Submite">Submite</option>
                                            <option value="Note Submite">Note Submite</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" value="{{$progress[0]->sms4}}" name="semes4" placeholder="Semester 1"  >
                                            <option value=""></option>
                                            <option value="Submite">Submite</option>
                                            <option value="Note Submite">Note Submite</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" value="{{$progress[0]->tne1}}" name="tne1" placeholder="Semester 1"  >
                                            <option value=""></option>
                                            <option value="Submite">Submite</option>
                                            <option value="Note Submite">Note Submite</option>
                                        </select>
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" value="{{$progress[0]->tne2}}" name="tne2" placeholder="Semester 1"  >
                                            <option value=""></option>
                                            <option value="Submite">Submite</option>
                                            <option value="Note Submite">Note Submite</option>
                                        </select>
