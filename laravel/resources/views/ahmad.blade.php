...
<br>
				...
				<div style="text-align: center;">
					<a href="gallery.php" target="_self"  class="eltd-btn eltd-btn-medium eltd-btn-outline eltd-btn-background-animation"  >            <span class="eltd-btn-background">            <span class="eltd-btn-background-inner" ></span>        </span>        <span class="eltd-btn-text">View Gallery</span>    </a>			
								</div>
